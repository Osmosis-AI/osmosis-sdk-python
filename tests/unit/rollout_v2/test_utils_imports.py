"""Tests for osmosis_ai.rollout_v2.utils.imports."""

import pytest

from osmosis_ai.rollout_v2.utils.imports import resolve_object, to_import_path
...
class TestResolveObject:
    ...
    def test_resolves_valid_import_path(self):
        cls = resolve_object("osmosis_ai.rollout_v2.utils.imports:resolve_object")
    ...
    def test_raises_on_missing_colon(self):
        with pytest.raises(ValueError, match="expected 'module:attr' format"):
            resolve_object("osmosis_ai.rollout_v2.utils.imports")

    def test_raises_on_nonexistent_attr(self):
        with pytest.raises(ImportError, match="does not export 'NoSuchThing'"):
            resolve_object("osmosis_ai.rollout_v2.utils.imports:NoSuchThing")
...
class TestToImportPath:
    def test_class_roundtrip(self):
        ...
        assert path == "osmosis_ai.rollout_v2.utils.concurrency:ConcurrencyLimiter"
